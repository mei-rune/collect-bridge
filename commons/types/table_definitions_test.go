...
func TestLoadTableDefinitions(t *testing.T) {
	...
	assertProperty(person.Attributes["ID1"], &ColumnDefinition{AttributeDefinition{Name: "ID1",
		Type:         GetTypeDefinition("integer"),
		DefaultValue: "0"}}, 0)
	assertProperty(person.Attributes["Name"], &ColumnDefinition{AttributeDefinition{Name: "Name",
		Type:         GetTypeDefinition("string"),
		DefaultValue: "mfk",
		Restrictions: []Validator{&StringLengthValidator{
			MinLength: 3, MaxLength: 13}}}}, 1)
	assertProperty(person.Attributes["Name2"], &ColumnDefinition{AttributeDefinition{Name: "Name2",
		Type:         GetTypeDefinition("string"),
		DefaultValue: "mfk",
		Restrictions: []Validator{&StringLengthValidator{
			MinLength: 3, MaxLength: 3}}}}, 2)
	assertProperty(person.Attributes["Age"], &ColumnDefinition{AttributeDefinition{Name: "Age",
		Type:         GetTypeDefinition("integer"),
		DefaultValue: "mfk",
	...
	assertProperty(person.Attributes["Mony"], &ColumnDefinition{AttributeDefinition{Name: "Mony",
		Type:         GetTypeDefinition("decimal"),
		DefaultValue: "1.3",
		Restrictions: []Validator{&DecimalValidator{
			MinValue: 1.0, MaxValue: 3.0}}}}, 5)
	assertProperty(person.Attributes["IP"], &ColumnDefinition{AttributeDefinition{Name: "IP",
		Type:         GetTypeDefinition("ipAddress"),
		DefaultValue: net.ParseIP("12.12.12.12")}}, 6)
	mac, _ := net.ParseMAC("12-12-12-12-12-12")
	assertProperty(person.Attributes["MAC"], &ColumnDefinition{AttributeDefinition{Name: "MAC",
	...
	assertProperty(person.Attributes["Password"], &ColumnDefinition{AttributeDefinition{Name: "Password",
		Type:         GetTypeDefinition("password"),
		DefaultValue: "mfk"}}, 9)

	assertProperty(employee.Attributes["Job"], &ColumnDefinition{AttributeDefinition{Name: "Job",
		Type:         GetTypeDefinition("string"),
		DefaultValue: "developer"}}, 0)
	assertProperty(employee.Attributes["company_test_id"], &ColumnDefinition{AttributeDefinition{Name: "company_test_id",
	...
	// 	return
	// }
	assertBelongsTo(employee.Assocations[0], &BelongsTo{TargetTable: company, Name: employee.Attributes["company_test_id"]}, 0)
