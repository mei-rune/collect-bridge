...
type requestBuffer struct {
	...
	elements []*mgrRequest /* vector of elements                   */
}

func newRequestBuffer(elements []*mgrRequest) *requestBuffer {
	return &requestBuffer{elements: elements}
}

func (self *requestBuffer) Init(elements []*mgrRequest) {
...
func (self *requestBuffer) Push(elem *mgrRequest) {
...
func (self *requestBuffer) Get(idx int) *mgrRequest {
	if self.IsEmpty() {
		return nil
	}
...
func (self *requestBuffer) Pop() *mgrRequest {
	if self.IsEmpty() {
		return nil
	}
...
func (self *requestBuffer) First() *mgrRequest {
	if self.IsEmpty() {
		return nil
	}
...
func (self *requestBuffer) Last() *mgrRequest {
	if self.IsEmpty() {
		return nil
	}
...
/* Read all elements.*/
func (self *requestBuffer) All() []*mgrRequest {
	if 0 == self.count {
		return nil
	}

	res := make([]*mgrRequest, 0, self.count)
