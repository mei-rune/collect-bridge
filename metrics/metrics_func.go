...
func (self *SnmpBase) GetInt64(params map[string]string, oid string) (map[string]interface{}, commons.RuntimeError) {
...
func (self *SnmpBase) GetInt64Value(params map[string]string, oid string, defaultValue int64) (map[string]interface{}, int64, commons.RuntimeError) {
	params["snmp.oid"] = oid
	params["snmp.action"] = "get"
	res, err := self.drv.Get(params)
	if nil == res || nil != err {
...
func (self *SnmpBase) GetUint64(params map[string]string, oid string) (map[string]interface{}, commons.RuntimeError) {
...
func (self *SnmpBase) GetValues(params map[string]string, oids []string) (map[string]interface{}, map[string]interface{}, commons.RuntimeError) {
