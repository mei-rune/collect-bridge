...
var index_html_1 = `<!DOCTYPE html>
<html>

<head lang='en'>
    <link href="/static/delayed_jobs/dj_mon.css" media="screen, projection" rel="stylesheet" type="text/css" />
    <link href="/static/delayed_jobs/bootstrap.css" media="screen, projection" rel="stylesheet" type="text/css" />

    <script src="/static/delayed_jobs/jquery.min.js" type="text/javascript"></script>
    <script src="/static/delayed_jobs/dj_mon.js" type="text/javascript"></script>
    <script src="/static/delayed_jobs/bootstrap_tooltip.js" type="text/javascript"></script>
    <script src="/static/delayed_jobs/bootstrap_tab.js" type="text/javascript"></script>
    <script src="/static/delayed_jobs/bootstrap_popover.js" type="text/javascript"></script>
    <script src="/static/delayed_jobs/bootstrap_modal.js" type="text/javascript"></script>
    <script src="/static/delayed_jobs/mustache.js" type="text/javascript"></script>
</head>
...
<script>
var dj_counts_dj_reports_url = "/delayed_jobs/counts"
</script>
...
var index_html = index_html_1 + index_html_2
