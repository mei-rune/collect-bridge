...
var all_get_tests = []struct {
	...
	{expression: `a`, input: []interface{}{"a", 12}, value: 12, e: "value is not a map, actual is []interface {}"},
	{expression: `[1]`, input: []interface{}{"a", 12}, value: 12},
	{expression: `[1]`, input: Return([]interface{}{"a", 12}), value: 12},
	{expression: `[-1]`, input: []interface{}{"a", 12}, value: 12, e: "invalid index"},
	...
	{expression: `[0].b`, input: []interface{}{map[string]interface{}{"a": 12}}, e: ValueNotFound.Error()},
	{expression: `b`, input: map[string]interface{}{"a": 12}, e: ValueNotFound.Error()},
	{expression: `a`, input: map[string]interface{}{"a": 12}, value: 12}}

func TestToSimpleValue(t *testing.T) {
	for i, test := range all_get_tests {
		ret, e := ToSimpleValue(test.input, test.expression)
		if nil != e {
			if 0 == len(test.e) {
