...
var test_statements = []struct {
	...
	/* 18 */ {query: map[string]string{"@id[0]": "[gt]1", "@id[1]": "[lt]10"}, sql: " id > $1 AND id < $2", params: []interface{}{int64(1), int64(10)}, err: ""},
	/* 19 */ {query: map[string]string{"@id[0]": "[gt]1", "@id[1]": "[lt]10", "@Name[0]": "aa", "@Name[1]": "[!=]cc"}, sql: " id > $1 AND id < $2 AND Name = $3 AND Name != $4", params: []interface{}{int64(1), int64(10), "aa", "cc"}, err: ""}}
...
var test_statements2 = []struct {
	query  map[string][]string
	sql    string
	params []interface{}
	err    string
}{{query: map[string][]string{"@id": []string{"1"}}, sql: " id = $1", params: []interface{}{int64(1)}, err: ""},
	/* 1  */ {query: map[string][]string{"@id": []string{"[gt]1"}}, sql: " id > $1", params: []interface{}{int64(1)}, err: ""},
	/* 2  */ {query: map[string][]string{"@id": []string{"[gte]1"}}, sql: " id >= $1", params: []interface{}{int64(1)}, err: ""},
	/* 3  */ {query: map[string][]string{"@id": []string{"[eq]1"}}, sql: " id = $1", params: []interface{}{int64(1)}, err: ""},
	/* 4  */ {query: map[string][]string{"@id": []string{"[lt]1"}}, sql: " id < $1", params: []interface{}{int64(1)}, err: ""},
	/* 5  */ {query: map[string][]string{"@id": []string{"[lte]1"}}, sql: " id <= $1", params: []interface{}{int64(1)}, err: ""},
	/* 6  */ {query: map[string][]string{"@id": []string{"[ne]1"}}, sql: " id != $1", params: []interface{}{int64(1)}, err: ""},
	/* 7  */ {query: map[string][]string{"@id": []string{"[in]1,2,3"}}, sql: " id IN ( 1,2,3 )", params: nil, err: ""},
	/* 8  */ {query: map[string][]string{"@id": []string{"[nin]1,2,3"}}, sql: " id NOT IN ( 1,2,3 )", params: nil, err: ""},
	/* 9  */ {query: map[string][]string{"@Name": []string{"[in]1,2,3"}}, sql: " Name IN ( '1', '2', '3' )", params: nil, err: ""},
	/* 10 */ {query: map[string][]string{"@Name": []string{"[nin]1,2,3"}}, sql: " Name NOT IN ( '1', '2', '3' )", params: nil, err: ""},
	/* 11 */ {query: map[string][]string{"@id": []string{"[between]1"}}, err: "it must has two value"},
	/* 12 */ {query: map[string][]string{"@id": []string{"[between]1,2"}}, sql: " (id BETWEEN $1 AND $2)", params: []interface{}{int64(1), int64(2)}, err: ""},
	/* 13 */ {query: map[string][]string{"@Name": []string{"[between]1,2"}}, sql: " (Name BETWEEN $1 AND $2)", params: []interface{}{"1", "2"}, err: ""},
	/* 14 */ {query: map[string][]string{"@id": []string{"[is]null"}}, sql: " id IS NULL", params: nil, err: ""},
	/* 15 */ {query: map[string][]string{"@id": []string{"[eq]1"}, "@Name": []string{"aa"}}, sql: " id = $1 AND Name = $2", params: []interface{}{int64(1), "aa"}, err: ""},
	/* 16 */ {query: map[string][]string{"@id": []string{"[eq]1"}, "@Name": []string{"aa"}, "@Age": []string{"2"}}, sql: " id = $1 AND Name = $2 AND Age = $3", params: []interface{}{int64(1), "aa", int64(2)}, err: ""},
	/* 17 */ {query: map[string][]string{"@id": []string{"[eq]1"}, "@Name": []string{"[between]1,2"}, "@Age": []string{"2"}}, sql: " id = $1 AND (Name BETWEEN $2 AND $3) AND Age = $4", params: []interface{}{int64(1), "1", "2", int64(2)}, err: ""},
	/* 18 */ {query: map[string][]string{"@id": []string{"[gt]1", "[lt]10"}}, sql: " id > $1 AND id < $2", params: []interface{}{int64(1), int64(10)}, err: ""},
	/* 19 */ {query: map[string][]string{"@id": []string{"[gt]1", "[lt]10"}, "@Name": []string{"aa", "[!=]cc"}}, sql: " id > $1 AND id < $2 AND Name = $3 AND Name != $4", params: []interface{}{int64(1), int64(10), "aa", "cc"}, err: ""}}
...
func TestCriteria2(t *testing.T) {
	...
	for i, m := range test_statements2 {
		var buffer bytes.Buffer
		builder := &whereBuilder{table: person,
			idx:          1,
			isFirst:      true,
		...
		e := builder.buildWithQueryParams(m.query)
		if nil != e {
			if 0 == len(m.err) {
				t.Errorf("index is %v, sql is %v, error is %v\r\n", i, m.sql, e)
				continue
