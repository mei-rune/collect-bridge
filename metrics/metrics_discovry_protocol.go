...
func (self *cisco_discovry_protocol) Get(params map[string]string) commons.Result {
...
func (self *huawei_discovry_protocol) Get(params map[string]string) commons.Result {
