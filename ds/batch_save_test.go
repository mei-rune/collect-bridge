...
func TestIntQueryByParent(t *testing.T) {
	srvTest2(t, "etc/mj_models.xml", func(client *Client, definitions *types.TableDefinitions) {
		...
		id := create(t, client, "device", js)
		drv := findByIdWithIncludes(t, client, "device", id, "interface,trigger,snmp_params")
...
func TestIntQueryByParent2(t *testing.T) {
	srvTest2(t, "etc/mj_models.xml", func(client *Client, definitions *types.TableDefinitions) {
		...
		triggers := findByParent(t, client, "device", id, "metric_rule", nil)
		...
		create(t, client, "redis_action", action1)
		create(t, client, "redis_action", action2)

		actions := findByParent(t, client, "metric_rule", tr1, "redis_action", nil)
...
func TestIntQueryByChild(t *testing.T) {
	srvTest2(t, "etc/mj_models.xml", func(client *Client, definitions *types.TableDefinitions) {
		...
		checkDevice(t, findByChild(t, client, "device", "interface", fmt.Sprint(ifc1["_id"])), js)
		checkDevice(t, findByChild(t, client, "device", "interface", fmt.Sprint(ifc2["_id"])), js)
		...
		checkDevice(t, findByChild(t, client, "device", "trigger", fmt.Sprint(tr1["_id"])), js)
		checkDevice(t, findByChild(t, client, "device", "trigger", fmt.Sprint(tr2["_id"])), js)
	})
}
