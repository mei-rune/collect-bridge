...
// func (self *cpu) GetCiscoHost(params commons.Map) commons.Result {
// 	return self.GetWindows(params)
// }

// func (self *cpu) GetCiscoSAN(params commons.Map) commons.Result {
...
// }
// func (self *cpu) GetCiscoSCE(params commons.Map) commons.Result {
// 	cpu := int32(-1)
...
// func (self *cpu) GetCisco(params commons.Map) commons.Result {
...
// func (self *cpu) GetWindows(params commons.Map) commons.Result {
// 	cpus := make([]int, 0, 4)
