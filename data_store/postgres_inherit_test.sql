...
DROP TABLE IF EXISTS tpt_mails CASCADE;
DROP TABLE IF EXISTS tpt_syslogs CASCADE;
DROP TABLE IF EXISTS tpt_db_commands CASCADE;
DROP TABLE IF EXISTS tpt_exec_commands CASCADE;
DROP TABLE IF EXISTS tpt_notification_groups CASCADE;
DROP TABLE IF EXISTS tpt_histories CASCADE;
DROP TABLE IF EXISTS tpt_alerts CASCADE;
DROP TABLE IF EXISTS tpt_redis_commands CASCADE;
DROP TABLE IF EXISTS tpt_actions CASCADE;
DROP TABLE IF EXISTS tpt_metric_triggers CASCADE;
DROP TABLE IF EXISTS tpt_triggers CASCADE;
DROP TABLE IF EXISTS tpt_wbem_params CASCADE;
DROP TABLE IF EXISTS tpt_ssh_params CASCADE;
DROP TABLE IF EXISTS tpt_snmp_params CASCADE;
DROP TABLE IF EXISTS tpt_endpoint_params CASCADE;
DROP TABLE IF EXISTS tpt_access_params CASCADE;
DROP TABLE IF EXISTS tpt_network_links CASCADE;
DROP TABLE IF EXISTS tpt_network_addresses CASCADE;
DROP TABLE IF EXISTS tpt_network_device_ports CASCADE;
